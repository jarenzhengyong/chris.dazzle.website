...
class greenPageLoader extends PolymerElement {
    ...
    constructor(){
        super();
        let res = store.get('my-order') || null;
        ...
        if (Dazzle.editMode==="normal"){
            ...
            if (!res) {
                alert("You don't have order. Please order something before confirmation.");
                location.href="/index.html";            
        ...
        // this.orderManager.getDataByES(this.itemId).then(res=>{
            res['name'] = this.user['name'];
            res['email'] = this.user['email'];
            res['mobile'] = this.user['mobile'];
            res['address'] = this.user['address'];
            ...
            let json = [
                    {
                        ...
                        "amount":{
                            ...
                            "breakdown":{
                                ...
                                "shipping":{"currency_code":"HKD","value":15},
