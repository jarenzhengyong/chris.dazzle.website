...
class greenPageLoader extends PolymerElement {
    ...
    ready(){
        super.ready();
                this.itemManager = new DataPackage('user');
        ...
        //     console.log(user);
        //     if (window.location.href != "https://kctea.dazzle.website/edit-myaccount.html") {
        //         if (confirm('You are currently logged in. Would you like to switch account?')) {
        ...
        //         }   
        //     } else {
        //         this.userManager.getDataByES(user['id']).then(res=>{
        //             console.log(document.querySelectorAll("[name='email']"));
        //             document.querySelectorAll("[name='email']").value = res["email"];
        //             document.getElementById("name-field").value = res["name"];
        //             document.getElementById("email-field").value = res["email"];
        //             document.getElementById("mobile-field").value = res["mobile"];
        //             document.getElementById("gender-field").value = res["gender"];
        //         });
                
        //     }
        // } else {
        //     if (window.location.href == "https://kctea.dazzle.website/edit-myaccount.html") {
        //         alert("You are not loggin in currently, please login.");
    ...
    _register() {
        ...
        let emailEntry = this.digestForm()["email"];
        console.log(this.userManager.getDataByCache(emailEntry)["id"],'register');
        console.log(this.userManager.getDataByES(emailEntry))
        this.userManager.getDataByES(emailEntry).then(res=>{
